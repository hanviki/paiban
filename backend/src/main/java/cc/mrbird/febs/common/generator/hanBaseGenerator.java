...
public class hanBaseGenerator {
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/xhschedule?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    private static final String PageUrl = "D:/project/project_schedule/frontend/src/views/";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"mdl_b_profession"}); // 需要生成的表
        ...
        eliminateFiledsList.add("audit_suggestion");
        eliminateFiledsList.add("IsUse");
...
//        searchFiledsList.add("state");
        ...
        focList.add(new FileOutConfig("/templates/test/list.vue.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return PageUrl + moduleName + "/" + tableInfo.getEntityName() + "/" + tableInfo.getEntityName() + "Index.vue";
            }
        });
