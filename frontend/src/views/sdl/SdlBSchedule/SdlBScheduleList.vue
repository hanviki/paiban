          ...
          <div :class="advanced ? null : 'fold'">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="开始日期" v-bind="formItemLayout">
                <a-date-picker @change="onstartDateFromChange" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="开始日期" v-bind="formItemLayout">
                <a-date-picker @change="onstartDateToChange" />
              </a-form-item>
            </a-col>
            <template v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item label="结束日期" v-bind="formItemLayout">
                  <a-date-picker @change="onendDateFromChange" />
                </a-form-item>
              </a-col>

              <a-col :md="8" :sm="24">
                <a-form-item label="结束日期" v-bind="formItemLayout">
                  <a-date-picker @change="onendDateToChange" />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
    ...
    <div>
      <div class="operator">
        ...
        <a-button v-hasPermission="['sdlBSchedule:delete']" @click="batchDelete"
          >删除</a-button
        >
        <a-dropdown v-hasPermission="['sdlBSchedule:export']">
          <a-menu slot="overlay">
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon
            v-hasPermission="['sdlBSchedule:update']"
            type="setting"
            theme="twoTone"
            twoToneColor="#4a9ff5"
            @click="edit(record)"
          ...
          ></a-icon>
          <a-badge
            v-hasNoPermission="['sdlBSchedule:update']"
            status="warning"
            text="无权限"
          ></a-badge>
        </template>
