  ...
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        ...
        <import-excel
          v-hasPermission="['mdlBArchive:import']"
          templateUrl="mdlBArchive/downTemplate"
          @succ="handleRefesh"
          url="mdlBArchive/import"
        >
        </import-excel>
      </div>
      <!-- 表格区域 -->
...
<script>
import MdlBArchiveAdd from "./MdlBArchiveAdd";
import MdlBArchiveEdit from "./MdlBArchiveEdit";
...
export default {
  name: "MdlBArchive",
  components: { MdlBArchiveAdd, MdlBArchiveEdit, ImportExcel },
  data() {
    return {
      advanced: false,
      dataSource: [],
  ...
  methods: {
    ...
    edit(record) {
      this.$refs.mdlBArchiveEdit.setFormValues(record);
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk() {
          let mdlBArchiveIds = that.selectedRowKeys.join(",");
          that.$delete("mdlBArchive/" + mdlBArchiveIds).then(() => {
