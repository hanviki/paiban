...
<script>
// import XxbBLcmanyAdd from "./XxbBLcmanyAdd";
import XxbBShow from "../XxbBShow";
import XxbBLcmanyEdit from "./XxbBLcmanyEdit";
...
export default {
  name: "XxbBLcmany",
  components: { XxbBLcmanyEdit, XxbBShow, XxbBDeptFlowLook },
  data() {
    return {
      advanced: false,
      dataSource: [],
  ...
  methods: {
    ...
    add() {
      ...
      // this.$refs.xxbBLcmanyAdd.setFormValues();
    ...
    openEdit () {
      ...
      this.$refs.xxbBLcmanyEdit.setFormValues(null,'新增',this.projectType);
    },
    handleEditSuccess() {
    ...
    view(record) {
      this.$refs.xxbBLcmanyEdit.setFormValues(record,'查看',this.projectType);
      this.editVisiable = true;
    },
    edit(record) {
      this.$refs.xxbBLcmanyEdit.setFormValues(record,'修改',this.projectType);
      this.editVisiable = true;
    },
    batchDelete() {
